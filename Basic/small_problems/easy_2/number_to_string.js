...
Explicits: - no explicit methods (concatenatio, String method, toString method)
Implicits: none

Data Struture: number --> array ---> string

Algorithm:
- declare a const variable DIGITs to an array of digits that are strings
- declare a variable resultString and assign it the value of empty string
- for /of loop
  - for value in DIGITs
