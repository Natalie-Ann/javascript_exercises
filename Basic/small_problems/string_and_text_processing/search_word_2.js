...
Input: word, string
Output: string with words highlighted

Explicits:  - output string should have input word(s) highlighted
            - highlighted = all caps with ** on both sides
Implicits: 

Data Strucure: string --> array of words --> string

Algorithm:
- Start function with word and string parameter
  - Convert the string into an array of words
  - Iterate through the wordsArray, use map to create new array
    - if word === element, then reassign the element to **ALLCAPS**
  - Return newArray
