...
Output: Boolean true/false; true if year is a leap year
Explicit rules: leap year = year % 4 === 0 unless also year % 100 === 0; 
if year % 100 ==== 0, not a leap year unless year % 400 === 0
