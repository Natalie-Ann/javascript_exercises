...
// The new catamaran class doesn't fit well with our existing class hierarchy: Catamarans don't have tires, and aren't wheeled vehicles. 
// However, we still want to share the code for tracking fuel efficiency and range. 
// Modify the class definitions and move code into a mix-in, as needed, to share code between the Catamaran and the wheeled vehicle classes.
...
Object.assign(WheeledVehicle.prototype, vehicleMixin);
...
class Catamaran {
  constructor(propellerCount, hullCount, kmTravelledPerLiter, fuelCapInLiter) {
    ...
    this.fullEfficiency = kmTravelledPerLiter;
    this.fuelCap = fuelCapInLiter;
  }
}

Object.assign(Catamaran.prototype, vehicleMixin);