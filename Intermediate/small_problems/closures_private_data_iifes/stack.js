...
// push takes a value and appends it to the stack. pop removes and returns the last element from the stack. printStack 
// logs each remaining element of the stack on its own line, starting with the item that was least recently added to the stack and 
...
let exampleStack = newStack();
exampleStack.push('string');
exampleStack.push(2);
