...
Explicits:  - output string is the longest sentence in the input string; longest = most # of words; also log the word count
            - words = characters separated by spaces
Implicits: 
...
- Start function with string parameter
  - Convert string to array of sentences using period or ? or ! as separator
  - Iterate through the sentenceArray
    - Split each sentence into array of words
      - Get the length of the array of words for each sentence
      - Sort the lengths from longest to shortest
...
function longestSentence(string) {
  ...
  sentenceArray.forEach(sentence => {
    let sentenceLength = sentence.split(' ');
